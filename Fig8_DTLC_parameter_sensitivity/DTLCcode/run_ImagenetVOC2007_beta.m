...
result = [];
for i=1:7
    if i==1 options.beta=0.1;
    elseif i==2 options.beta=0.5;
    elseif i==3 options.beta=1;
    elseif i==4 options.beta=5;
    elseif i==5 options.beta=10;
    elseif i==6 options.beta=50;
    elseif i==7 options.beta=100;
    end
