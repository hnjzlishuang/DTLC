...
result = [];
for i=1:7
    if i==1 options.eta=0.005;
    elseif i==2 options.eta=0.01;
    elseif i==3 options.eta=0.05;
    elseif i==4 options.eta=0.1;
    elseif i==5 options.eta=1;
    elseif i==6 options.eta=10;
    elseif i==7 options.eta=100;
    end
